...
const PrivacyPolicy = () => {
  return (
    <div>
      <p>
        Privacy Policy Last updated: January 18, 2025 This Privacy Policy
        ...
        of the Privacy Policy Generator. Interpretation and Definitions
        ...
        Company", "We", "Us" or "Our" in this Agreement) refers to VocabBuilder.
        ...
        Ukraine Device means any device that can access the Service such as a
        ...
        a page visit). Website refers to VocabBuilder, accessible from
        https://vocab-builder-zeta.vercel.app You means the individual accessing
        ...
        not limited to: Email address First name and last name Usage Data Usage
        Data Usage Data is collected automatically when using the Service. Usage
        ...
        through a mobile device. Information from Third-Party Social Media
        Services The Company allows You to create an account and log in to use
        the Service through the following Third-party Social Media Services:
        ...
        Your Third-Party Social Media Service's account, such as Your name, Your
        email address, Your activities or Your contact list associated with that
        account. You may also have the option of sharing additional information
        ...
        during registration or otherwise, You are giving the Company permission
        to use, share, and store it in a manner consistent with this Privacy
        Policy. Tracking Technologies and Cookies We use Cookies and similar
        ...
        legally obligated to retain this data for longer time periods. Transfer
        of Your Personal Data Your information, including Personal Data, is
        ...
        us: By email: danklymenko.worki@gmail.com
      </p>
    </div>
  );
};
